    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
                ...
                $simpan = $_POST['simpan'];
                    if($item == "tv") {
                        $total = 3000000 * $total + $biaya_kurir + $biaya_jaminan;
                    } else if ($item == "refrigator") {
                        $total = 6000000 * $total + $biaya_kurir + $biaya_jaminan;
                    } else{
                        $total = 4000000 * $total + $biaya_kurir + $biaya_jaminan;
                    }
            ?>
            </div>
            <div class="col-3 mt-3">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Courier Cost : <?= "Rp " . number_format($biaya_kurir, 0, ".", "."); ?></li>
                    <li class="list-group-item">Assurance Cost : <?= "Rp " . number_format($biaya_jaminan, 0, ".", "."); ?> </li>
                    <li class="list-group-item">Total Cost : <?= "Rp " . number_format($total, 0, ".", "."); ?></li>
